...
test.doILPV2ShortExamplePerGene <- function() {
	...
	res <- doILP(obs_mat, delta, lambda, b, n, K, T_=NULL, annot, delta_type,prior=NULL, sourceNode=NULL, sinkNode=NULL, all.int=FALSE, all.pos=FALSE, flag_v2=TRUE)
...
test.doILPV2ShortExamplePerGeneExp <- function() {

	true_result_objval <- 9.894474
	true_result_solution <- c(0.0000000, 0.7947368, 0.0000000, 
														0.0000000, 0.0000000, 0.7947368, 
														0.0000000, 0.0000000, 0.0000000, 
														0.0000000, 0.0000000, 0.0000000, 
